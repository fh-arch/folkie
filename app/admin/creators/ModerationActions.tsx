...
import { verifyCreator, suspendCreator, reactivateCreator } from "./actions";
...
export function CreatorModerationActions({ creatorId, isVerified, isActive }: Props) {
